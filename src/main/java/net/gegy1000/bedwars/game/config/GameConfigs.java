package net.gegy1000.bedwars.game.config;
...
public final class GameConfigs {
    ...
    public static void register() {
        ...
        serverData.registerReloadListener(new SimpleSynchronousResourceReloadListener() {
            ...
            public Identifier getFabricId() {
                return new Identifier(BedWarsMod.ID, "games");
            }
            ...
            public void apply(ResourceManager manager) {
                ...
                Identifier root = new Identifier(BedWarsMod.ID, "games");
                ...
                for (Identifier path : resources) {
                    try {
                        ...
                        BedWarsMod.LOGGER.error("Failed to read configured game at {}", path, e);
                    }
                }
            }
        });
    ...
    private static Identifier identifierFromPath(Identifier location) {
        ...
        return new Identifier(
                ...
                path.substring("games/".length(), path.length() - ".json".length())
        );
    }
