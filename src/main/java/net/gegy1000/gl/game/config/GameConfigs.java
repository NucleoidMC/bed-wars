package net.gegy1000.gl.game.config;
    ...
    public static void register() {
        ...
        serverData.registerReloadListener(new SimpleSynchronousResourceReloadListener() {
            ...
            public Identifier getFabricId() {
                return new Identifier(GameLib.ID, "games");
            }
            ...
            public void apply(ResourceManager manager) {
                ...
                Identifier root = new Identifier(GameLib.ID, "games");
                    ...
                    try {
                        ...
                        try (Reader reader = new BufferedReader(new InputStreamReader(resource.getInputStream()))) {
                            ...
                            decode.error().ifPresent(error -> {
                                GameLib.LOGGER.error("Failed to decode {}: {}", path, error.toString());
                            });
                        }
                    } catch (IOException e) {
                        GameLib.LOGGER.error("Failed to read configured game at {}", path, e);
                    }
                }
            }
        });
